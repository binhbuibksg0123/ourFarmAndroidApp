...
class MqttClientHelper constructor(context: Context?) {
    companion object {
//        @Volatile
//        private lateinit var instance: MqttClientHelper
//
//        fun getInstance(context: Context?): MqttClientHelper {
//            synchronized(this) {
//                if (!::instance.isInitialized) {
//                    instance = MqttClientHelper(context)
//                }
//                return instance
//            }
//        }
